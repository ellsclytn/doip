...
class LoctekKeypad : public Component, public UARTDevice, public Sensor
{

public:
  LoctekKeypad(UARTComponent *parent) : UARTDevice(parent) {}
   ...
   void loop() override
  {
    while (available() > 0)
    {
      ...
      /* ESP_LOGD("DEBUG", "Incoming keypad byte is: %08x", incomingByte); */
